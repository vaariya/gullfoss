...
<body>
    ...
    <section id="team-part" class="pt-60">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="singel-team text-center mt-30">
                        <div class="team-image">
                            <img src="images/team/t-1.jpg" alt="Team">
                        </div>
                        <div class="team-content">
                            <h6>Alexander Michael Mila</h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="singel-team text-center mt-30">
                        <div class="team-image">
                            <img src="images/team/t-4.jpg" alt="Team">
                        </div>
                        <div class="team-content">
                            <h6>Alexander Michael Mila</h6>
                            <p>Finance & Commerce</p>
